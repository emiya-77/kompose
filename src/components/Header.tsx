        ...
        <div className='flex items-center gap-5'>
          ...
          <Show when="signed-out">
            <SignInButton mode="modal">
              <Button variant="ghost" size="sm" className="h-8 text-white/70 px-4 rounded-full -mr-2">
                Sign In
              </Button>
            </SignInButton>
            <SignUpButton mode="modal">
              <Button size="sm" className="h-8 rounded-full font-semibold active:scale-95 px-4 animate-pulse">
                Get Started
